...
class LeaveCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'startdate':forms.DateInput(attrs={'type':"date", 'class':'form-control','placeholder':'2021-12-23'}),
            'enddate':forms.DateInput(attrs={'type':"date", 'class':'form-control','placeholder':'2021-12-23'}),
